(function ($) {
    ...
    $(function () {
        ...
        $("#btnSubmit").on("click", function (e) {
            ...
            if (!e.isDefaultPrevented()) {
                ...
                $.notify("Please send an email to 'maruf.mhb@gmail.com' ");

               // alert("Thank you! Please send an email to maruf.mhb@gmail.com")
                return;
                $.ajax({
                    type: "POST",
                    url: url,
    ...
    $(document).on("ready", function () {
        ...
        $(".clients.owl-carousel")
            .imagesLoaded()
            .owlCarousel({ nav: true, items: 2, loop: false, navText: false, margin: 10, autoHeight: false, responsive: { 0: { items: 2 }, 768: { items: 4 }, 1200: { items: 6 } } });
        $(".text-rotation").owlCarousel({ loop: true, dots: false, nav: false, margin: 0, items: 1, autoplay: true, autoplayHoverPause: false, autoplayTimeout: 3800, animateOut: "fadeOut", animateIn: "fadeIn" });
        // $("body").magnificPopup({
        //     delegate: "a.lightbox",
        //     type: "image",
        //     removalDelay: 300,
